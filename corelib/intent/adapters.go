...
//   - ssh -> "ssh"
//   - non_coding, browser, search, live_data, document_delivery, document_generate, business_data, database, office, screenshot, knowledge_write, current_time -> "non_coding"
...
func (r *ClassificationResult) ToTaskIntent() (intent, matched string, evidence []string, reason string, confidence float64) {
	...
	case LabelNonCoding, LabelBrowser, LabelSearch, LabelLiveData, LabelLiveDataVisual, LabelDocumentDelivery, LabelDocumentGenerate, LabelBusinessData, LabelDatabase, LabelOffice, LabelScreenshot, LabelKnowledgeWrite, LabelCurrentTime, LabelAudioSynthesize, LabelAudioDeliver, LabelDocumentOpen:
		intent = "non_coding"
	default:
...
//   - non_coding, search, live_data, document_delivery, document_generate, business_data, database, office, screenshot, knowledge_write, current_time, browser, ssh -> "non_coding"
...
func (r *ClassificationResult) ToGateIntent() (intent string, confidence float64, gap float64, layer int, reason string) {
	...
	case LabelMaintenance:
		intent = "maintenance"
	case LabelNonCoding, LabelSearch, LabelLiveData, LabelLiveDataVisual, LabelDocumentDelivery, LabelDocumentGenerate, LabelBusinessData, LabelDatabase, LabelOffice, LabelScreenshot, LabelKnowledgeWrite, LabelCurrentTime, LabelBrowser, LabelSSH, LabelAudioSynthesize, LabelAudioDeliver, LabelDocumentOpen:
		intent = "non_coding"
...
// (non_coding, browser, search, live_data, document_delivery, document_generate, business_data, database, office, screenshot, knowledge_write, or current_time).
