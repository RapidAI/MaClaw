#!/usr/bin/env python3
"""Check spectral quality of Go vs ONNX outpu— detecelectronic noise."""
imporos, wave, struct, numpy as np
...
if noos.path.exists(go_path) or noos.path.exists(onnx_path):
continue
...
if hf_ratio > 0.1:
print(f"[WARN] High HF noise: {100*hf_ratio:.1f}% energy above 8kHz")
else:
print(f"[OK] HF noise OK: {100*hf_ratio:.1f}% energy above 8kHz")
