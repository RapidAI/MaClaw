// corelib/agent/selfconfirm.go — Self-confirmation detection helpers for NeedsConfirm gate.
//
...
//
// Migrated from gui/im_message_handler_selfconfirm.go as part of the
