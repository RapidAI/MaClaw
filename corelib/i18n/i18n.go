...
var translations = map[string]map[string]string{
	"zh": {
		...
		MsgTUILLMNotConfiguredHint: "LLM 未配置，请在配置 Tab 或 GUI 中设置 maclaw_llm_url 和 maclaw_llm_model",
	...
	"en": {
		...
		MsgTUILLMNotConfiguredHint: "LLM is not configured. Set maclaw_llm_url and maclaw_llm_model in Config tab or GUI",
