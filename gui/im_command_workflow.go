...
var workflowTypeAliases = map[string]string{
	...
	"bid_review":   string(v2.WorkflowBidReview),
	...
	"标书检查":  string(v2.WorkflowBidReview),
	"标书审查":  string(v2.WorkflowBidReview),
	"检查标书":  string(v2.WorkflowBidReview),
	"改标":    string(v2.WorkflowBidReview),
