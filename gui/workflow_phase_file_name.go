...
var knownPhaseFileNames = map[string]string{
	...
	// --- New parametric academic phase IDs (generated by BuildAcademicApplicationTemplate) ---
	// These are the canonical IDs for newly created workflows. The old IDs above
	// remain for backward compat with already-persisted workflow states.
