...
export const WorkflowsPage = ({ lang, switchToAI }: { lang?: string; switchToAI?: () => void }) => {
    ...
    const handleClick = useCallback((workflowType: string) => {
        ...
        // Switch to AI assistant panel first, then start the workflow there.
        // The slight delay ensures the tab switch renders before the backend
        // begins emitting workflow events to the AI panel.
