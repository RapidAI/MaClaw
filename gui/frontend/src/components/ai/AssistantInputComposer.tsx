...
export function AssistantInputComposer(props: AssistantInputComposerProps) {
    ...
    return (
        <div data-testid="ai-input-bar" style={{ display: "flex", flexDirection: "column", gap: "6px", padding: "8px 12px", paddingBottom: "max(8px, env(safe-area-inset-bottom))", background: t.inputBarBg, borderTop: inline ? `1px solid ${t.inputBarBorder}` : "none", flex: inputAreaHeight ? "1 1 auto" : undefined, flexShrink: 0, minWidth: 0, minHeight: "76px", boxSizing: "border-box", overflow: "hidden", ...(inline ? {} : { margin: "0 10px 10px 10px", borderRadius: "8px", border: `1.5px solid ${t.inputBarBorder}` }) }}>
            ...
            <div style={{ display: "flex", alignItems: "flex-end", gap: "8px", flex: inputAreaHeight ? 1 : undefined, minHeight: 0 }}>
