        ...
        <>
            ...
            <button type="button" onClick={handleVoiceClick} onPointerDown={handleVoicePointerDown} onPointerUp={finishVoicePointer} onPointerCancel={finishVoicePointer} onPointerLeave={handleVoicePointerLeave} onContextMenu={(e) => e.preventDefault()} disabled={voiceDisabled} data-testid="ai-voice-input" style={{ ...getInputActionButtonStyle(t, themeMode, voiceInput.state === "listening" ? "voiceHold" : "voice", voiceDisabled), position: "relative", marginBottom: "4px", touchAction: "none", overflow: "hidden" }} title={!voiceInput.asrReady ? localizeText(lang, "Voice input unavailable - enable ASR model first", "\u8bed\u97f3\u8f93\u5165\u4e0d\u53ef\u7528\uff0c\u8bf7\u5148\u542f\u7528 ASR \u6a21\u578b") : voiceInput.state === "listening" ? localizeText(lang, "Listening - click to stop", "\u76d1\u542c\u4e2d\uff0c\u70b9\u51fb\u505c\u6b62") : voiceInput.state === "transcribing" ? localizeText(lang, "Transcribing...", "\u8bc6\u522b\u4e2d...") : localizeText(lang, "Voice input", "\u8bed\u97f3\u8f93\u5165")} aria-label={localizeText(lang, "Voice input", "\u8bed\u97f3\u8f93\u5165")}>
                {voiceInput.state === "transcribing" ? (
                    ...
                    <VoiceLevelVisualizer onAudioLevelRef={voiceInput.onAudioLevelRef} isSpeaking={voiceInput.isSpeaking} themeColor="#ffffff" speakingColor={themeMode === "dark" ? "#fecaca" : "#dc2626"} />
                ) : (
            ...
            {isBusy && cancelSession ? (
                <button type="button" onClick={handleCancel} data-testid="ai-cancel-progress" style={{ ...getInputActionButtonStyle(t, themeMode, "cancel"), marginBottom: "4px" }} title={localizeText(lang, "Cancel", "\u53d6\u6d88")} aria-label={localizeText(lang, "Cancel", "\u53d6\u6d88")}>
                ...
                <button type="button" onClick={handleSend} disabled={!canSend} style={{ ...getInputActionButtonStyle(t, themeMode, canSend ? "send" : "neutral", !canSend), marginBottom: "4px" }} title={localizeText(lang, "Send", "\u53d1\u9001")}>
