...
export const defaultLightScheme: AssistantLightScheme = {
    ...
    cssVars: {
        ...
        surfaceMuted: "#f3f5f8",
        primary: "#2f5f98",
        primaryStrong: "#1d4a7a",
        primarySoft: "rgba(47, 95, 152, 0.08)",
        textPrimary: "#1f2937",
        ...
        danger: "#c43d34",
        dangerBg: "rgba(196, 61, 52, 0.06)",
        linkColor: "#2f5f98",
        infoBg: "rgba(47, 95, 152, 0.06)",
    },
    assistantTheme: {
        bg: "#f7f9fc",
        titleBarBg: "#eef2f7",
...
export const notionLightScheme: AssistantLightScheme = {
    ...
    assistantTheme: {
        ...
        btnColor: "#2f3437",
        btnBorder: "#d4d3d0",
        actionBtnColor: "#9b9a97",
        closeBtnColor: "#9b9a97",
        sendBtnColor: "#ffffff",
...
export const linearLightScheme: AssistantLightScheme = {
    ...
    assistantTheme: {
        ...
        btnColor: "#5e6ad2",
        btnBorder: "#c4c8e4",
        actionBtnColor: "#8a8f98",
        closeBtnColor: "#8a8f98",
        sendBtnColor: "#ffffff",
