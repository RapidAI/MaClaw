    ...
    return [
        {
            ...
            items: [
                ...
                { type: "coding_subagent", icon: "keyboard", label: localizeText("Quick Coding", "简化编程", "簡化程式"), description: localizeText("Template form, then CodingSubAgent", "填写模板表单后启动编程智能体", "填寫模板表單後啟動程式智能體") },
                { type: "remote_coding_subagent", icon: "monitor", label: localizeText("Remote Coding", "远程编程", "遠端程式"), description: localizeText("Template form, then remote CodingSubAgent", "填写远程模板表单后启动编程智能体", "填寫遠端模板表單後啟動程式智能體") },
