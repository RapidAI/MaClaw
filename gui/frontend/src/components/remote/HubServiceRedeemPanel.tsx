        ...
        <div style={panelStyle}>
            ...
            <div style={cardStyle}>
                <div style={{ marginBottom: 12 }}>
                    ...
                    <input
                        ...
                        placeholder={t("Enter service card code", "输入服务兑换码")}
                        style={inputStyle}
                    />
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
                    <div style={{ ...valueStyle, color: colors.textSecondary, flex: 1, minWidth: 220 }}>
                        {t(
                            ...
                            "兑换成功后，如果当前账号获得授权，系统会自动启用 Hub 托管的 MaClaw 模型服务。"
                        )}
                    </div>
            ...
            <div style={cardStyle}>
                ...
                <div style={{ display: "grid", gap: 12 }}>
                    ...
                    <div>
                        <div style={labelStyle}>{t("Available Models", "可用模型名")}</div>
                    ...
                    <div>
                        ...
                        <div style={{ display: "grid", gap: 8 }}>
                            {(status?.active_grants || []).length ? (status?.active_grants || []).map((grant, index) => (
                                ...
                                <div style={{ ...valueStyle, color: colors.textMuted }}>{t("No active grants", "暂无有效授权")}</div>
                            )}
                        </div>
                    </div>
                    <div>
                        <div style={labelStyle}>{t("Authorized Models", "授权模型清单")}</div>
                        <div style={{ display: "grid", gap: 8 }}>
