...
export function GroupDiscussionSettingsPanel({ config, saveRemoteConfigField, lang, onOpenExperienceTrace }: Props) {
  ...
  return <div style={panelStyle}>
    ...
    <GroupDiscussionHistoryPanel lang={lang} enabled={current.enabled} onOpenExperienceTrace={onOpenExperienceTrace} />
    ...
    <Section title={c.invite} desc={c.inviteDesc}>
      ...
      <div style={{ marginTop: "12px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "12px", alignItems: "stretch" }}>
        ...
        <ToggleRow checked={current.use_cross_agent_experience} onChange={(checked) => save({ use_cross_agent_experience: checked })}>{text("Use cross-agent experience for expert selection", "\u5141\u8bb8\u8de8 Agent \u7ecf\u9a8c\u5f71\u54cd\u4e13\u5bb6\u9009\u62e9", "\u5141\u8a31\u8de8 Agent \u7d93\u9a57\u5f71\u97ff\u5c08\u5bb6\u9078\u64c7")}</ToggleRow>
