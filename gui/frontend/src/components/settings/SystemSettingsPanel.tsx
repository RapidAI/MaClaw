        ...
        <div className="settings-panel system-settings-panel">
            <section className="system-settings-card">
                ...
                <div className="system-settings-number-grid">
                    ...
                    <SystemTimeoutField label={textForLang(lang, 'Agent Response Timeout (sec)', 'Agent \u54cd\u5e94\u8d85\u65f6\uff08\u79d2\uff09', 'Agent \u56de\u61c9\u903e\u6642\uff08\u79d2\uff09')} value={(config as any)?.agent_response_timeout_sec || 240} fieldName="agent_response_timeout_sec" saveRemoteConfigField={saveRemoteConfigField} title={textForLang(lang, 'How long the AI assistant may stay silent before the foreground request is marked timed out. Range: 240-600 seconds.', 'AI \u52a9\u624b\u5728\u524d\u53f0\u8bf7\u6c42\u4e2d\u591a\u4e45\u6ca1\u6709 token \u6216\u8fdb\u5ea6\u540e\u5224\u5b9a\u8d85\u65f6\u3002\u8303\u56f4\uff1a240-600 \u79d2\u3002', 'AI \u52a9\u624b\u5728\u524d\u53f0\u8acb\u6c42\u4e2d\u591a\u4e45\u6c92\u6709 token \u6216\u9032\u5ea6\u5f8c\u5224\u5b9a\u903e\u6642\u3002\u7bc4\u570d\uff1a240-600 \u79d2\u3002')} />
                    <SystemTimeoutField label={textForLang(lang, 'LLM Request Timeout (sec)', 'LLM \u8bf7\u6c42\u8d85\u65f6\uff08\u79d2\uff09', 'LLM \u8acb\u6c42\u903e\u6642\uff08\u79d2\uff09')} value={(config as any)?.maclaw_llm_timeout_sec || 240} fieldName="maclaw_llm_timeout_sec" saveRemoteConfigField={saveRemoteConfigField} title={textForLang(lang, 'HTTP timeout for MaClaw LLM calls. Range: 240-600 seconds.', 'MaClaw LLM \u8c03\u7528\u7684 HTTP \u8d85\u65f6\u3002\u8303\u56f4\uff1a240-600 \u79d2\u3002', 'MaClaw LLM \u8abf\u7528\u7684 HTTP \u903e\u6642\u3002\u7bc4\u570d\uff1a240-600 \u79d2\u3002')} />
                </div>
