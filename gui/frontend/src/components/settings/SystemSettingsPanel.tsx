        ...
        <div className="settings-panel system-settings-panel">
            <section className="system-settings-card">
                ...
                <div className="system-settings-number-grid">
                    ...
                    <SystemTimeoutField label={textForLang(lang, 'Skill Runner Timeout (sec)', 'Skill Runner \u8fd0\u884c\u8d85\u65f6\uff08\u79d2\uff09', 'Skill Runner \u57f7\u884c\u903e\u6642\uff08\u79d2\uff09')} value={(config as any)?.skill_runner_timeout_sec || 600} fieldName="skill_runner_timeout_sec" saveRemoteConfigField={saveRemoteConfigField} min={240} max={14400} defaultValue={600} step={60} title={textForLang(lang, 'Maximum runtime for local SkillRunner jobs and default bash step timeout. Long document translation can raise this up to 14400 seconds. Per-skill global_timeout still takes priority.', '\u672c\u5730 SkillRunner \u4efb\u52a1\u7684\u6700\u957f\u8fd0\u884c\u65f6\u95f4\uff0c\u4e5f\u4f5c\u4e3a bash \u6b65\u9aa4\u7684\u9ed8\u8ba4\u8d85\u65f6\u3002\u957f\u6587\u6863\u7ffb\u8bd1\u53ef\u8c03\u9ad8\u5230 14400 \u79d2\uff1bSkill \u81ea\u5df1\u7684 global_timeout \u4f18\u5148\u3002', '\u672c\u5730 SkillRunner \u4efb\u52d9\u7684\u6700\u9577\u57f7\u884c\u6642\u9593\uff0c\u4e5f\u4f5c\u70ba bash \u6b65\u9a5f\u7684\u9810\u8a2d\u903e\u6642\u3002\u9577\u6587\u4ef6\u7ffb\u8b6f\u53ef\u8abf\u9ad8\u5230 14400 \u79d2\uff1bSkill \u81ea\u5df1\u7684 global_timeout \u512a\u5148\u3002')} />
