...
const settingsTabIcons: Record<SettingsTabId, string> = {
    ...
    hardware: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="8" height="8" rx="1"/><path d="M6 1.5v2M10 1.5v2M6 12.5v2M10 12.5v2M1.5 6h2M1.5 10h2M12.5 6h2M12.5 10h2"/><circle cx="8" cy="8" r="1.5"/></svg>',
...
export const getSettingsTabOptions = (lang: string, options: { hideVirtualEmployee?: boolean } = {}): SettingsTabOption[] => {
    const tabs: SettingsTabOption[] = [
        ...
        },
        {
            ...
            label: textForLang(lang, 'Hardware Access', '硬件接入', '硬體接入'),
            desc: textForLang(lang, 'Pair and manage hardware devices', '配对和管理硬件设备', '配對和管理硬體裝置'),
            icon: settingsTabIcons.hardware,
        },
        {
