export const translations: Record<string, Record<string, string>> = {
    ...
    "zh-Hans": {
        ...
        "systemDefault": "系统默认",
        "envCheckTitle": "正在准备环境",
        "envCheckSubtitle": "正在准备运行环境，请稍候 — 就绪后将自动打开应用。",
        "envCheckPreparingStatus": "正在准备运行时...",
    ...
    "zh-Hant": {
        ...
        "systemDefault": "系統默認",
        "envCheckTitle": "正在準備環境",
        "envCheckSubtitle": "正在準備運行環境，請稍候 — 就緒後將自動開啟應用。",
        "envCheckPreparingStatus": "正在準備運行時...",
