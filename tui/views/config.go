...
func configDisplayNameForLang(key, lang string) string {
	zh := map[string]string{
		"setup_status": "初始化状态", "onboarding": "初始化", "configuration": "配置", "hub_url": "Hub 服务地址", "hubcenter_url": "HubCenter 地址", "token": "认证令牌", "data_dir": "数据目录", "working_directory_profile": "工作目录方案", "working_directory": "自定义工作目录", "language": "界面语言", "max_iterations": "最大轮数", "agentnet_enabled": "AgentNet 开关", "check_update_on_startup": "启动检查更新",
