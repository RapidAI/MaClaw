...
CREATE TABLE IF NOT EXISTS centers (
	...
	iworker_ready INTEGER NOT NULL DEFAULT 0,
	iworker_readiness_status TEXT NOT NULL DEFAULT '',
	iworker_tenant_count INTEGER NOT NULL DEFAULT 0,
	iworker_role_count INTEGER NOT NULL DEFAULT 0,
	iworker_colleague_count INTEGER NOT NULL DEFAULT 0,
	iworker_local_account_count INTEGER NOT NULL DEFAULT 0,
	iworker_agent_instance_count INTEGER NOT NULL DEFAULT 0,
	iworker_readiness_json TEXT NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS skill_market_skills (
	...
	source_center_id TEXT NOT NULL DEFAULT '',
...
var centerIntegrationMigrations = []string{
	...
	`ALTER TABLE centers ADD COLUMN iworker_ready INTEGER NOT NULL DEFAULT 0`,
	`ALTER TABLE centers ADD COLUMN iworker_readiness_status TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE centers ADD COLUMN iworker_tenant_count INTEGER NOT NULL DEFAULT 0`,
	`ALTER TABLE centers ADD COLUMN iworker_role_count INTEGER NOT NULL DEFAULT 0`,
	`ALTER TABLE centers ADD COLUMN iworker_colleague_count INTEGER NOT NULL DEFAULT 0`,
	`ALTER TABLE centers ADD COLUMN iworker_local_account_count INTEGER NOT NULL DEFAULT 0`,
	...
	`ALTER TABLE skill_market_skills ADD COLUMN source_center_id TEXT NOT NULL DEFAULT ''`,
