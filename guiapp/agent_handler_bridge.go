...
var registerAgentHandlerFactoryOnce sync.Once

// RegisterAgentHandlerFactory is the composition-root factory for TUI and
// cmd/maclaw-gui. Tests that need agent.NewHandler must call it explicitly.
func RegisterAgentHandlerFactory() {
	registerAgentHandlerFactoryOnce.Do(func() {
