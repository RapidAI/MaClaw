...
func (s codingWorkbenchStepStatus) MarshalJSON() ([]byte, error) {
	type alias codingWorkbenchStepStatus
	copy := alias(s)
	copy.RuntimeStatus = agentruntime.ProjectLegacyJobStatus(s.Status)
