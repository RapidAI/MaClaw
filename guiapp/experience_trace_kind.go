...
const (
	...
	experienceTraceKindToolRecoveryPattern   experienceTraceKindID = experienceTraceKindID(agentruntime.ExperienceTraceKindToolRecoveryPattern)
...
const (
	...
	experienceTraceSourceToolUsage      experienceTraceSourceType = experienceTraceSourceType(agentruntime.ExperienceTraceSourceToolUsage)
