...
func normalizeMobileBackendSSHStatus(session *mobileBackendSSHSession) {
	if session != nil {
		session.RuntimeStatus = agentruntime.ProjectLegacyJobStatus(session.Status)
	}
}
func normalizeMobileBackendSSHTaskStatus(task *mobileBackendSSHTask) {
	if task != nil {
		task.RuntimeStatus = agentruntime.ProjectLegacyJobStatus(task.Status)
	}
}
func normalizeMobileBackendSSHFileStatus(operation *mobileBackendSSHFileOperation) {
	if operation != nil {
		operation.RuntimeStatus = agentruntime.ProjectLegacyJobStatus(operation.Status)
	}
}
...
func (c *RemoteHubClient) claimMobileBackendSSHSession() (*mobileBackendSSHSessionClaimResponse, error) {
	...
	normalizeMobileBackendSSHStatus(out.Session)
	return &out, nil
}
...
func (c *RemoteHubClient) updateMobileBackendSSHSession(sessionID string, payload map[string]any) (*mobileBackendSSHSession, error) {
	...
	normalizeMobileBackendSSHStatus(&out)
	return &out, nil
}
...
func (c *RemoteHubClient) claimMobileBackendSSHTask() (*mobileBackendSSHTaskClaimResponse, error) {
	...
	normalizeMobileBackendSSHTaskStatus(out.Task)
	return &out, nil
}
...
func (c *RemoteHubClient) claimMobileBackendSSHFileOperation() (*mobileBackendSSHFileOperationClaimResponse, error) {
	...
	normalizeMobileBackendSSHFileStatus(out.Operation)
	return &out, nil
}
