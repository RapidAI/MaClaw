...
var expertToolMetaByName = map[string]expertToolMeta{
	...
	"database":       {Category: "system", Risk: "elevated", LabelZh: "数据库写入/导出", LabelEn: "Database write / export"},
	"database_query": {Category: "system", Risk: "safe", LabelZh: "数据库只读查询", LabelEn: "Database read-only query"},
