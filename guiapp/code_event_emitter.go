...
// Optional projectPath is the local tab identity used by the frontend to keep
// the session on the task that produced it.
func (e *CodeEventEmitter) EmitPreviewSessionStart(sessionID string, projectPath ...string) {
	e.EmitSessionStartAutoOpen(sessionID, projectPath...)
}
