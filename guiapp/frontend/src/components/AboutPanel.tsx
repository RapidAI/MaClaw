...
const registrationContactErrorKeys: Array<[string, string]> = [
    ...
    ['EMAIL_ROUTED_TO_ANOTHER_HUB', 'aboutContactErrorEmailRoutedToAnotherHub'],
    ['EMAIL_DOMAIN_NOT_ALLOWED', 'aboutContactErrorEmailDomainNotAllowed'],
    ['EMAIL_BIND_CHECK_FAILED', 'aboutContactErrorEmailBindCheckFailed'],
    ['EMAIL_LOOKUP_FAILED', 'aboutContactErrorEmailLookupFailed'],
    ['EMAIL_BIND_FAILED', 'aboutContactErrorEmailBindFailed'],
    ['PHONE_ALREADY_REGISTERED', 'aboutContactErrorPhoneAlreadyRegistered'],
    ['PHONE_REGISTRATION_LOOKUP_FAILED', 'aboutContactErrorPhoneLookupFailed'],
    ['PHONE_REGISTRATION_ROUTE_CHECK_FAILED', 'aboutContactErrorPhoneRouteCheckFailed'],
    ['PHONE_BIND_FAILED', 'aboutContactErrorPhoneBindFailed'],
    ['PHONE_CONTACT_USE_SMS_REGISTRATION', 'aboutContactErrorPhoneUseSmsRegistration'],
    ...
    ['MAIL_SEND_FAILED', 'aboutContactErrorMailSendFailed'],
    ['CODE_GEN_FAILED', 'aboutContactErrorCodeGenFailed'],
    ['PHONE_REGISTRATION_DISABLED', 'aboutContactErrorPhoneRegistrationDisabled'],
    ['INVALID_EMAIL', 'aboutContactErrorInvalidEmail'],
    ['INVALID_PHONE_NUMBER', 'aboutContactErrorInvalidPhoneNumber'],
    ['INVALID_SMS_VERIFY_REQUEST', 'aboutContactErrorInvalidSmsVerifyRequest'],
    ['REGISTRATION_AUTH_LOAD_FAILED', 'aboutContactErrorSmsConfigUnavailable'],
    ['SMS_DAILY_LIMIT_CHECK_FAILED', 'aboutContactErrorSmsLimitCheckFailed'],
    ['SMS_VERIFY_SEND_FAILED', 'aboutContactErrorSmsSendFailed'],
    ['SMS_VERIFY_CHECK_FAILED', 'aboutContactErrorSmsCheckFailed'],
    ...
    ['USER_NOT_FOUND', 'aboutContactErrorUserNotFound'],
    ['INVALID_CONTACT_KIND', 'aboutContactErrorInvalidContactKind'],
];
...
export function AboutPanel({
    ...
    const hubCenterURL = hubCenterBaseURL || emptyValue;
    const developerCommunityURL = hubCenterBaseURL
        ? `${hubCenterBaseURL.replace(/\/+$/, '')}/developer`
        : '';
