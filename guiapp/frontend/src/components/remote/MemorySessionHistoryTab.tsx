...
const overlayStyle: WailsNoDragStyle = { position: "fixed", inset: 0, background: colors.overlay, display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999, WebkitAppRegion: "no-drag", "--wails-draggable": "no-drag" };
const viewerStyle: WailsNoDragStyle = { background: colors.surface, borderRadius: radius.lg, boxShadow: "var(--shadow-xl, 0 12px 40px -8px rgba(30,58,95,0.22))", width: "90vw", maxWidth: 700, maxHeight: "80vh", display: "flex", flexDirection: "column", overflow: "hidden", WebkitAppRegion: "no-drag", "--wails-draggable": "no-drag" };
const dialogStyle: WailsNoDragStyle = { background: colors.surface, borderRadius: radius.lg, padding: "20px 24px", minWidth: 280, boxShadow: "var(--shadow-lg, 0 8px 28px -6px rgba(30,58,95,0.18))", WebkitAppRegion: "no-drag", "--wails-draggable": "no-drag" };
