            ...
            <tr style={{ borderTop: `1px solid ${colors.border}` }}>
                <td style={tdStyle} title={server.endpoint_url}>
                    <div style={{ display: "flex", alignItems: "center", gap: "6px", flexWrap: "wrap" }}>
                        ...
                        {server.runtime_sync_status && <span style={runtimeNeedsReviewStyle} title={server.runtime_sync_last_error || undefined}>{server.runtime_sync_status === "needs_review" ? translate("mcpRuntimeNeedsReview") : translate("mcpRuntimeSyncPending")}</span>}
                    </div>
                </td>
                ...
                <td style={tdStyle}>
                    <div style={{ display: "flex", gap: "4px", flexWrap: "wrap", alignItems: "center" }}>
                        ...
                        {server.runtime_sync_status && server.source === "marketplace" && server.capability && <button className="btn-secondary" style={smallBtnStyle} onClick={onRuntimeRetry} disabled={busy}>{translate("mcpRuntimeRetry")}</button>}
