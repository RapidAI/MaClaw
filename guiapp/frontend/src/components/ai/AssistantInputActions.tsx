...
>) {
    ...
    const menuItemHoverBg = dark ? "rgba(148, 163, 184, 0.14)" : `color-mix(in srgb, ${t.btnColor} 8%, transparent)`;
    const iconColor = t.btnColor;
            ...
            {composeAction && (
                <button
                    ...
                    style={{
                        ...
                        background: `color-mix(in srgb, ${t.btnColor} ${dark ? "14%" : "8%"}, ${t.fieldBg})`,
                        color: t.btnColor,
                        fontSize: "11px",
                        lineHeight: 1,
                        cursor: "pointer",
