    ...
    return (
        <button
            ...
            style={{
                ...
                outline: "none",
                background: state === "ok"
                    ? "color-mix(in srgb, var(--theme-success, #16a34a) 16%, transparent)"
                    : "transparent",
                color: state === "ok"
                ...
                opacity: state === "busy" ? 0.65 : emphasize ? 1 : 0.55,
                boxShadow: "none",
        ...
        >
            ...
            {state === "ok"
                ...
                : <IconClipboard size={12} color="currentColor" />}
        </button>
    );
}
