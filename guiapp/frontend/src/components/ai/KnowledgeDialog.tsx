...
const overlayStyle: WailsNoDragStyle = {
    position: "fixed",
    inset: 0,
    background: "var(--theme-overlay, rgba(15, 23, 42, 0.50))",
...
const modalStyle: WailsNoDragStyle = {
    ...
    boxShadow: "var(--shadow-xl, 0 20px 60px rgba(30, 58, 95, 0.22), 0 0 0 1px rgba(30, 58, 95, 0.06))",
    display: "flex",
...
const toastStyle: CSSProperties = {
    ...
    background: "var(--theme-overlay-strong, rgba(15, 23, 42, 0.94))",
    color: "var(--theme-overlay-text, #f8fafc)",
    boxShadow: "var(--shadow-lg, 0 16px 36px rgba(30, 58, 95, 0.24))",
    fontSize: "13px",
    lineHeight: 1.45,
    zIndex: 1,
    textAlign: "left",
