...
/**
 * Fluent Azure — cool gray-white surfaces with bright azure accents.
 * Matches the Windows 11 Fluent / WinUI light look (white cards, cool rails,
 * near-black titles, vivid blue icons).
 */
export const fluentLightScheme: AssistantLightScheme = {
    ...
    description: {
        en: "Cool gray-white surfaces with bright azure accents, inspired by Windows 11 Fluent.",
        zhHans: "冷灰白底搭配明亮天蓝强调，灵感来自 Windows 11 Fluent。",
        zhHant: "冷灰白底搭配明亮天藍強調，靈感來自 Windows 11 Fluent。",
    },
    cssVars: {
        pageBg: "#f7f8fa",
        surface: "#ffffff",
        ...
        primarySoft: "rgba(74, 140, 255, 0.10)",
        textPrimary: "#1a1c1e",
        ...
        linkColor: "#4a8cff",
        infoBg: "rgba(74, 140, 255, 0.06)",
    },
    assistantTheme: {
        bg: "#f7f8fa",
        titleBarBg: "#f0f2f5",
        titleBarBorder: "#e4e7ec",
        titleText: "#1a1c1e",
        text: "#1a1c1e",
        textMuted: "#6b7280",
        inputBarBg: "#ffffff",
        inputBarBorder: "#e4e7ec",
        inputText: "#1a1c1e",
        codeBg: "#eef0f3",
        codeText: "#2f73f5",
        codeBlockBg: "#f7f8fa",
        codeBlockBorder: "#e4e7ec",
        codeBlockLang: "#6b7280",
        borderLeft: "#e4e7ec",
        responseBorderLeft: "#b7d0ff",
        headingColor: "#1a1c1e",
        linkColor: "#4a8cff",
        pathColor: "#4b5563",
        promptColor: "#4b5563",
