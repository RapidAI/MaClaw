...
function participantIconStyle(p: Participant, theme: Theme): CSSProperties {
    ...
    return {
        ...
        flexShrink: 0,
        color: isLocal ? "#4f7f6f" : theme.btnColor,
        background: isLocal ? "rgba(79, 127, 111, 0.12)" : `color-mix(in srgb, ${theme.btnColor} 10%, ${theme.fieldBg})`,
        border: `1px solid ${isLocal ? "rgba(79, 127, 111, 0.26)" : theme.btnBorder}`,
    };
}
