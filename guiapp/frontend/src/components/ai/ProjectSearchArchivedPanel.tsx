...
import { searchSurfaceRootStyle } from "./projectSearchSurface";
...
export function ProjectSearchArchivedPanel({ name, content, loading, lang, theme: t, panelRef, onClose }: {
    ...
    return (
        <div ref={panelRef} data-testid="project-search-archived-panel" role="dialog" aria-modal="true" aria-label={localizeText(lang, "Archived task", "已归档任务")} style={searchSurfaceRootStyle(t)}>
            <div style={{ display: "flex", alignItems: "center", gap: "8px", padding: "8px 12px", borderBottom: `1px solid ${t.titleBarBorder}`, flexShrink: 0 }}>
