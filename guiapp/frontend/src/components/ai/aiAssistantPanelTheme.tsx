...
export const lightTheme: Theme = fluentLightScheme.assistantTheme;
export const overlayTheme: Theme = fluentLightScheme.assistantTheme;
...
export function getInputActionButtonStyle(
    ...
    const sendFill = (t.sendBtnBg && t.sendBtnBg.trim()) || accent;
    const sendInk = (t.sendBtnColor && t.sendBtnColor.trim()) || contrastingInkOnFill(sendFill);
    const wash = (amount: string) => `color-mix(in srgb, ${accent} ${amount}, ${t.fieldBg})`;
    const palette = {
        neutral: { color: t.textMuted, border: dark ? t.fieldBorder : t.btnBorder, bg: t.inputBarBg, shadow: dark ? "inset 0 1px 0 rgba(255,255,255,0.04)" : "0 1px 2px rgba(15,23,42,0.05), inset 0 1px 0 rgba(255,255,255,0.88)" },
        attach: { color: accent, border: t.btnBorder, bg: dark ? wash("12%") : wash("8%"), shadow: dark ? "inset 0 1px 0 rgba(255,255,255,0.05)" : `0 1px 2px color-mix(in srgb, ${accent} 12%, transparent), inset 0 1px 0 rgba(255,255,255,0.9)` },
        voice: { color: dark ? t.text : t.textMuted, border: t.fieldBorder, bg: t.inputBarBg, shadow: dark ? "inset 0 1px 0 rgba(255,255,255,0.04)" : "0 1px 2px rgba(15,23,42,0.05), inset 0 1px 0 rgba(255,255,255,0.86)" },
        voiceHold: { color: dark ? t.quoteText : t.textMuted, border: t.btnBorder, bg: wash("10%"), shadow: dark ? `0 0 0 2px color-mix(in srgb, ${accent} 10%, transparent), inset 0 1px 0 rgba(255,255,255,0.05)` : `0 0 0 2px color-mix(in srgb, ${accent} 10%, transparent), inset 0 1px 0 rgba(255,255,255,0.9)` },
        send: { color: sendInk, border: t.sendBtnBorder || sendFill, bg: sendFill, shadow: dark ? `0 4px 10px color-mix(in srgb, ${sendFill} 24%, transparent), inset 0 1px 0 rgba(255,255,255,0.10)` : `0 3px 8px color-mix(in srgb, ${sendFill} 22%, transparent), inset 0 1px 0 rgba(255,255,255,0.16)` },
        cancel: { color: accent, border: t.btnBorder, bg: dark ? wash("10%") : wash("6%"), shadow: dark ? "inset 0 1px 0 rgba(255,255,255,0.05)" : `0 1px 2px color-mix(in srgb, ${accent} 12%, transparent), inset 0 1px 0 rgba(255,255,255,0.9)` },
    }[tone];
...
export const AI_PANEL_STATIC_STYLE_TEXT = `
    ...
    .ai-window-control:focus-visible {
        outline: 2px solid color-mix(in srgb, var(--theme-primary) 48%, transparent);
        outline-offset: 1px;
    }
    ...
    .ai-titlebar-tool:focus-visible {
        outline: 2px solid color-mix(in srgb, var(--theme-primary) 38%, transparent);
        outline-offset: 1px;
    }
    ...
    .ai-plus-menu-item:hover:not(:disabled) { background: var(--ai-plus-menu-item-hover-bg, color-mix(in srgb, var(--theme-primary) 8%, transparent)) !important; }
    .ai-plus-menu-item:focus-visible:not(:disabled) {
        outline: 2px solid color-mix(in srgb, var(--theme-primary) 38%, transparent);
        outline-offset: -1px;
    }
    .ai-plus-menu-item[data-active="true"]:not(:disabled) {
        background: var(--ai-plus-menu-item-hover-bg, color-mix(in srgb, var(--theme-primary) 8%, transparent)) !important;
    }
