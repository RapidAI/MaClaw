...
export namespace corelib {
	...
	export class TokenUsageStat {
	    ...
	    cache_read_price_per_m_tokens_rmb?: number;
	    cache_write_price_per_m_tokens_rmb?: number;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.cache_write_tokens = source["cache_write_tokens"];
	        this.cache_usage_source = source["cache_usage_source"];
	        this.pricing_source = source["pricing_source"];
	        ...
	        this.cache_read_price_per_m_tokens_rmb = source["cache_read_price_per_m_tokens_rmb"];
	        this.cache_write_price_per_m_tokens_rmb = source["cache_write_price_per_m_tokens_rmb"];
	        this.cache_read_cost_rmb = source["cache_read_cost_rmb"];
	        this.cache_write_cost_rmb = source["cache_write_cost_rmb"];
	...
	export class SemanticToolScopeRoutingConfig {
	    enabled: boolean;
	    mode: string;
	    legacy_text_route: string;
	    require_catalog_coverage: boolean;
	    allow_degraded_read_only: boolean;
	    max_selections: number;
	    max_schema_tokens: number;
	    max_iterations: number;
	    constructor(source: any = {}) {
	        if (typeof source === "string") source = JSON.parse(source);
	        this.enabled = source["enabled"];
	        this.mode = source["mode"];
	        this.legacy_text_route = source["legacy_text_route"];
	        this.require_catalog_coverage = source["require_catalog_coverage"];
	        this.allow_degraded_read_only = source["allow_degraded_read_only"];
	        this.max_selections = source["max_selections"];
	        this.max_schema_tokens = source["max_schema_tokens"];
	        this.max_iterations = source["max_iterations"];
	    }
	...
	export class AppConfig {
	    ...
	    cloud_workspace_cache_encryption?: boolean;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.cloud_workspace_cache_encryption = source["cloud_workspace_cache_encryption"];
...
export namespace main {
	...
	export class CloudWorkspaceDeletedWorkspace {
	    ...
	    unreferenced_retained_bytes: number;
	    updated_at: string;
	    deleted_at: string;
	    purge_after: string;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.retained_bytes = source["retained_bytes"];
	        this.snapshot_retained_bytes = source["snapshot_retained_bytes"];
	        this.staging_bytes = source["staging_bytes"];
	        this.unreferenced_retained_bytes = source["unreferenced_retained_bytes"];
	        this.updated_at = source["updated_at"];
	...
	export class CloudWorkspaceEntitlement {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.tenant_max_total_bytes = source["tenant_max_total_bytes"] ?? source["TenantMaxTotalBytes"];
	        this.logical_bytes = source["logical_bytes"] ?? source["LogicalBytes"];
	        this.retained_bytes = source["retained_bytes"] ?? source["RetainedBytes"];
	        this.snapshot_retained_bytes = source["snapshot_retained_bytes"] ?? source["SnapshotBytes"];
	        this.staging_bytes = source["staging_bytes"] ?? source["StagingBytes"];
	        this.unreferenced_retained_bytes = source["unreferenced_retained_bytes"] ?? source["UnreferencedBytes"];
	...
	export class CloudWorkspaceEntitlementWorkspace {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.status = source["status"] ?? source["Status"];
	        ...
	        this.provision_state = source["provision_state"] ?? source["ProvisionState"];
	        this.provision_operation_id = source["provision_operation_id"] ?? source["ProvisionOpID"];
	        this.lease_in_use = source["lease_in_use"] ?? source["LeaseInUse"];
	        this.lease_holder = source["lease_holder"] ?? source["LeaseHolder"];
	        this.reconcile_required = source["reconcile_required"] ?? source["ReconcileRequired"];
	        this.reconcile_reason = source["reconcile_reason"] ?? source["ReconcileReason"];
	    }
	}
	...
	export class HubLLMResetVoucher {
	    id: string;
	    expires_at: string;
	    redeemed_at?: string;
	    static createFrom(source: any = {}) { return new HubLLMResetVoucher(source); }
	...
	export class LocalMCPServerView {
	    ...
	    runtime_sync_attempts?: number;
	    runtime_sync_last_error?: string;
	    runtime_sync_next_retry_at?: string;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.runtime_sync_status = source["runtime_sync_status"];
	        this.runtime_sync_attempts = source["runtime_sync_attempts"];
	        this.runtime_sync_last_error = source["runtime_sync_last_error"];
	        this.runtime_sync_next_retry_at = source["runtime_sync_next_retry_at"];
	    }
