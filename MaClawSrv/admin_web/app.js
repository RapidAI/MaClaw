...
Object.assign(fallbackLabels, {
  ...
  primaryLLM: "\u4e3b\u6a21\u578b\u0020\u004c\u004c\u004d",
  llmProviderListHint: "\u5171\u4eab\u0020provider\u0020\u5217\u8868\uff0c\u5f53\u524d\u9009\u62e9\u7684\u0020provider\u0020\u4f1a\u4f5c\u4e3a\u670d\u52a1\u5668\u9ed8\u8ba4\u0020\u0041\u0049\u0020\u6a21\u578b\u3002",
  llmFlatConfigHint: "\u5171\u4eab\u4e3b\u6a21\u578b\u5e73\u94fa\u8bbe\u7f6e\u3002\u5982\u679c\u9009\u62e9\u4e86\u0020provider\uff0c\u5efa\u8bae\u4e0e\u0020provider\u0020\u4fdd\u6301\u4e00\u81f4\u3002",
  localAICapabilities: "\u672c\u5730\u0020\u0041\u0049\u0020\u80fd\u529b",
  advancedAIConfig: "\u9ad8\u7ea7\u0020\u0041\u0049\u0020\u914d\u7f6e",
  auxiliaryLLM: "\u8f85\u52a9\u0020\u004c\u004c\u004d",
  knowledgeVisionLLM: "\u77e5\u8bc6\u0020Vision LLM",
  ttsVoice: "\u0054\u0054\u0053\u0020\u97f3\u8272",
  currentLLMProvider: "\u5f53\u524d\u0020LLM Provider",
  llmModel: "\u004c\u004c\u004d\u0020\u6a21\u578b",
  llmProtocol: "\u004c\u004c\u004d\u0020\u534f\u8bae",
  contextLength: "\u0043\u006f\u006e\u0074\u0065\u0078\u0074\u0020\u957f\u5ea6",
  llmTimeoutSec: "\u004c\u004c\u004d\u0020\u8d85\u65f6\uff08\u79d2\uff09",
  agentResponseTimeoutSec: "\u0041\u0067\u0065\u006e\u0074\u0020\u54cd\u5e94\u8d85\u65f6\uff08\u79d2\uff09",
  maxIterations: "\u6700\u5927\u8fed\u4ee3\u6b21\u6570",
  subagentConcurrency: "\u0053\u0075\u0062\u0061\u0067\u0065\u006e\u0074\u0020\u5e76\u53d1",
  dailyLLMBudgetUSD: "\u6bcf\u65e5\u0020\u004c\u004c\u004d\u0020\u9884\u7b97\uff08\u0055\u0053\u0044\uff09",
...
Object.assign(en, {
  ...
  llmProviderList: "LLM provider JSON",
  llmProviderListHint: "Shared provider list. The selected current provider becomes the server-wide default AI model.",
  llmFlatConfigHint: "Shared flat primary model settings. When a provider is selected, keep these aligned with that provider.",
  localAICapabilities: "Local AI capabilities",
  advancedAIConfig: "Advanced AI config",
  promptCache: "LLM prompt cache",
  auxiliaryLLM: "Auxiliary LLM",
  knowledgeVisionLLM: "Knowledge vision LLM",
  modelRoutes: "Model routes",
  ttsVoice: "TTS voice",
  ttsAutoVoiceSummary: "Auto voice reply in IM",
  currentLLMProvider: "Current LLM provider",
  llmURL: "LLM URL",
  llmModel: "LLM model",
  llmProtocol: "LLM protocol",
  contextLength: "Context length",
  llmTimeoutSec: "LLM timeout (sec)",
  agentResponseTimeoutSec: "Agent response timeout (sec)",
  maxIterations: "Max iterations",
  subagentConcurrency: "Subagent concurrency",
  dailyLLMBudgetUSD: "Daily LLM budget (USD)",
  ...
  modelRuntimeStatusHint: "Shows server-side shared model readiness. Paths stay hidden; OminiParser is not available here.",
...
Object.assign(zh, {
  ...
  primaryLLM: "\u4e3b\u529b LLM",
  currentLLMProvider: "\u5f53\u524d LLM \u63d0\u4f9b\u65b9",
  llmProviderList: "LLM \u63d0\u4f9b\u65b9\u5217\u8868 JSON",
  llmURL: "LLM \u63a5\u5165\u5730\u5740",
  llmModel: "LLM \u6a21\u578b",
  llmProtocol: "LLM \u534f\u8bae",
  localAICapabilities: "\u672c\u5730 AI \u80fd\u529b",
  ...
  selectVoice: "\u9009\u62e9\u97f3\u8272",
  voiceXiaoyi: "\u5c0f\u827a\uff0c\u4e2d\u6587\u5973\u58f0\uff0c\u9ed8\u8ba4",
  voiceXiaoxiao: "\u6653\u6653\uff0c\u4e2d\u6587\u5973\u58f0",
  voiceYunxi: "\u4e91\u5e0c\uff0c\u4e2d\u6587\u7537\u58f0",
  voiceYunyang: "\u4e91\u626c\uff0c\u4e2d\u6587\u7537\u58f0",
  modelReadyAction: "\u5df2\u5c31\u7eea",
  modelDownloadingAction: "\u540e\u53f0\u4e0b\u8f7d\u4e2d",
  modelDownloadAction: "\u7acb\u5373\u4e0b\u8f7d",
  modelDownloadStarted: "\u5df2\u53d1\u8d77\u6a21\u578b\u540e\u53f0\u4e0b\u8f7d",
  modelDownloadingHint: "\u670d\u52a1\u6b63\u5728\u540e\u53f0\u8865\u9f50\u8fd0\u884c\u6a21\u578b\uff0c\u901a\u5e38\u65e0\u9700\u91cd\u590d\u89e6\u53d1\u3002",
...
function bindKnowledgeActions(sources,publicLibraries,sharedCfg){
  ...
  $('saveKnowledgeImportDefaults').onclick=run(async()=>{ const result=await api('/api/v1/admin/client-config/default',{method:'PUT',body:JSON.stringify({app_config:{...(sharedCfg||{}),knowledge_include_images:$('knowledgeIncludeImages')?.checked===true}})}); show(result); toast(t("knowledgeImportDefaultsSaved")); });
...
function aiModelRuntimeState(model){ if(model?.downloading) return {key:"downloading",cls:"warn"}; if(model?.ready) return {key:"ready",cls:"ok"}; return {key:"missing",cls:"bad"}; }
function renderAIModelStatusPanel(models){ const names=["embedding","asr","tts"]; return `<section class="panel stack" id="aiModelStatusPanel"><div class="split"><div><h2>${t("modelRuntimeStatus")}</h2><p class="helper-text">${t("modelRuntimeStatusHint")}</p></div><button class="secondary" id="refreshAIModelStatus">${t("refresh")}</button></div><div class="ai-model-status-grid">${names.map(name=>{ const model=models?.[name]||{name}; const state=aiModelRuntimeState(model); const enabled=model.enabled!==false; const enabledText=enabled?`${t("enabledState")} ${t("autoEnabled")}`:t("disabledState"); const decoder=model.decoder?`<p class="muted">${esc(model.decoder)}: ${esc(model.decoder_ready===true?t("ready"):t("missing"))}</p>`:""; const encoder=model.encoder?`<p class="muted">${esc(model.encoder)}: ${esc(model.mp3_encoder_ready===true?t("ready"):t("missing"))}</p>`:""; const action=model.ready?`<button class="secondary" type="button" disabled>${esc(t("ready"))}</button>`:model.downloading?`<button class="secondary" type="button" disabled>${esc(t("backgroundDownloading"))}</button><p class="helper-text">${esc(t("downloadPendingHint"))}</p>`:`<button class="secondary" type="button" data-ai-model-download="${esc(name)}">${esc(t("downloadNow"))}</button>`; return `<article class="ai-model-status-card"><div class="split"><h3>${esc(name.toUpperCase())}</h3><span class="state-pill state-${state.cls}">${esc(t(state.key))}</span></div><p><span class="state-pill state-${enabled?"ok":"muted"}">${esc(enabledText)}</span></p><p class="helper-text">${esc(model.filename||"")}${model.voice_id?` · ${esc(model.voice_id)}`:""}</p>${decoder}${encoder}${model.size_bytes?`<p class="muted">${esc(String(model.size_bytes))} ${esc(t("bytesUnit"))}</p>`:""}${model.last_error?`<p class="error-text">${esc(model.last_error)}</p>`:""}${action}</article>`; }).join("")}</div></section>`; }
async function refreshAIModelStatus(silent=false){ const out=await api("/api/v1/admin/ai-models/status"); $("aiModelStatusPanel").outerHTML=renderAIModelStatusPanel(out.models||{}); bindAIModelStatusActions(); if(!silent) toast(t("modelStatusRefreshed")); return out; }
function bindAIModelStatusActions(){ if($("refreshAIModelStatus")) $("refreshAIModelStatus").onclick=async()=>{ try{ await refreshAIModelStatus(); }catch(e){ toast(`${t("failed")}: ${e.message}`); } }; document.querySelectorAll("[data-ai-model-download]").forEach(btn=>btn.onclick=async()=>{ const model=btn.dataset.aiModelDownload; btn.disabled=true; btn.textContent=t("backgroundDownloading"); try{ await api(`/api/v1/admin/ai-models/${encodeURIComponent(model)}/download`,{method:"POST"}); toast(t("downloadQueued")); await refreshAIModelStatus(true); }catch(e){ toast(`${t("failed")}: ${e.message}`); btn.disabled=false; btn.textContent=t("downloadNow"); } }); }
