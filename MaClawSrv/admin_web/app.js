...
Object.assign(en, {
  searchProviderHelp: "Choose which search engine MaClawSrv users use for web search. Brave, Serper, and TinyFish can use API keys; DuckDuckGo needs no key.",
...
Object.assign(zh, {
  searchProviderHelp: "选择 MaClawSrv 用户网页搜索使用的搜索服务。Brave、Serper、TinyFish 可配置 API Key；DuckDuckGo 无需 Key。",
  freeNoKey: "免费，无需 Key",
...
function defaultClientSearchProviders(){ return [{name:"Brave",type:"brave",base_url:"https://api.search.brave.com/res/v1/web/search"},{name:"Serper",type:"serper",base_url:"https://google.serper.dev/search"},{name:"TinyFish",type:"tinyfish",base_url:"https://api.search.tinyfish.ai"},{name:"DuckDuckGo",type:"duckduckgo"}]; }
