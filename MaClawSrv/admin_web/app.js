...
const state = { locale: localStorage.getItem("maclaw.admin.locale") || "zh-CN", token: localStorage.getItem("maclaw.admin.token") || "", section: "overview", me: null, pendingRiskFilter: null, pendingRequests: 0, locales: [{locale:"zh-CN",label:"zh-CN"},{locale:"en-US",label:"English"}] };
