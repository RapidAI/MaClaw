...
var openAPIRoutes = []openAPIRoute{
	...
	{Method: http.MethodGet, Path: "/api/v1/admin/i18n/locales", Summary: "Admin locales", Description: "Returns Admin Web supported locales and the configured default locale.", Tag: "admin", Security: adminSecurity()},
	{Method: http.MethodGet, Path: "/api/v1/admin/i18n/messages", Summary: "Admin locale messages", Description: "Returns Admin Web message strings for the requested locale.", Tag: "admin", Security: adminSecurity(), QueryParams: []string{"locale"}},
