...
var openAPIRoutes = []openAPIRoute{
	...
	{Method: http.MethodPost, Path: "/api/v1/device-pairings", Summary: "Create hardware-device pairing code", Description: "Creates a one-time six-digit code, valid for ten minutes, for a screenless hardware client. The code is never a bearer credential.", Tag: "messages", Security: bearerSecurity()},
