...
var openAPIRoutes = []openAPIRoute{
	...
	{Method: http.MethodPost, Path: "/api/im-gateway/v1/incoming", Summary: "Third-party IM incoming message", Description: "Accepts a third-party IM user message and routes it to the MaClawSrv user selected by the gateway bearer token.", Tag: "messages", Security: bearerSecurity()},
