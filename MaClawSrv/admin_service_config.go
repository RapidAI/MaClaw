...
func adminServiceConfigSchema() []adminServiceConfigSchemaField {
	fields := []adminServiceConfigSchemaField{
		...
		{Key: "security_policy_mode", EnvKey: "MACLAW_SECURITY_POLICY_MODE", Type: "enum", Default: "developer", Description: "Security policy mode for tool and Skill admission decisions.", RestartRequired: true, Writable: true, AllowedValues: []string{"developer", "relaxed", "standard", "strict"}},
