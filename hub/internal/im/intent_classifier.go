...
func (ic *IntentClassifier) Classify(
	...
	prompt := ic.buildPrompt(text, profiles, recentHistory)
	messages := []interface{}{
...
func (ic *IntentClassifier) buildPrompt(text string, profiles []DeviceProfile, history []routeHistoryEntry) string {
