...
func TestApprovalRolesHandlerNormalizesAndDedupesRoles(t *testing.T) {
	settings := &testSystemSettingsRepo{}
	payload := []byte(`{"functionScopes":[{"scopeId":" hr ","scopeName":" HR ","custom":true},{"scopeId":"hr","scopeName":"Duplicate"},{"scopeId":"hr_alt","scopeName":"HR"},{"scopeId":"","scopeName":"Risk & Compliance","custom":true}],"roles":[` +
	...
	if len(body.FunctionScopes) != 2 || body.FunctionScopes[0].ScopeID != "hr" || body.FunctionScopes[0].ScopeName != "HR" || body.FunctionScopes[1].ScopeID != "risk_compliance" {
