...
var i18nKeys = [
  ...
  'designWorkflow', 'emptyHint', 'nodeConfiguration', 'closeNodeConfiguration',
  'canvasTools', 'selectTool', 'connectTool', 'deleteEdgeTool', 'connectHint', 'deleteEdgeHint', 'edgeConnectorLabel',
  'configurationSuffix', 'deleteNode', 'label', 'description', 'triggerType', 'manual',
  'apiCall', 'schedule', 'event', 'formFieldsJson', 'approvalMode', 'singleApprover',
  'countersign', 'anyNOfM', 'sequential', 'approverIds', 'minApprovals', 'timeoutHours',
  'fallbackApprover', 'branchesJson', 'defaultBranch', 'actionType', 'selectPlaceholder',
