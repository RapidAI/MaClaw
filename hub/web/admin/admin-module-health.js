...
(function(global) {
  const checks = [
    ...
    { name: 'VoiceprintTab', ok: function() { return typeof global.loadVpConfig === 'function' && typeof global.loadVoiceprints === 'function'; } },
  ...
  function runChecks() {
    ...
    return global.__adminModuleHealth;
  }

  global.runAdminModuleHealthCheck = runChecks;
  runChecks();
})(window);