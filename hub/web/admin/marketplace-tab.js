...
(function(global) {
  ...
  if (typeof global.refreshAll === 'function') { const baseRefreshAll = global.refreshAll; global.refreshAll = async function() { await Promise.all([baseRefreshAll(), global.loadMarketplace()]); }; }
