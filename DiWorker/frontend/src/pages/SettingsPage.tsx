              ...
              <div className="dw-settings-group-list">
                <section className="dw-settings-group">
                  ...
                  <div className="dw-form-grid">
                    ...
                    <label>
                      端口
                      <input value={String(settings.center.port)} onChange={(event) => onCenterPortChange(event.target.value)} placeholder="8714" />
                    </label>
                    <label>
                      Base URL
                      <input value={settings.center.baseUrl} onChange={(event) => onCenterBaseUrlChange(event.target.value)} placeholder="http://127.0.0.1:8714" />
                    </label>
