...
evidence files, and non-Markdown evidence attachments such as continuation
release-gates, runtime-boundary, and final-release-evidence logs. Continuation
logs are useful local evidence snapshots, but they do not satisfy the completed
signed-build QA record requirement.
