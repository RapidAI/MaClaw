...
`tool/signed_artifact_evidence.py ios --record-dir docs/qa-builds --archive-or-build <path/to/MaClawMobile.xcarchive> --team-id <APPLE_TEAM_ID> --provisioning-profiles <profiles>`.
