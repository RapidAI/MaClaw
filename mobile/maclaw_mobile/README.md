...
only through a QR authorization generated by MaClaw desktop GUI.
...
Use `docs/user_guide.md` for the first-version mobile flows: information
lookup, emergency documents, manual SSH, digital employees, and account privacy
settings.
