...
### 1. iWorker AI Native 组织白皮书

面向潜在客户、合作伙伴与内部市场团队，解释 `iWorker` 不是单点 AI 工具，而是一套可持续运行的 AI Native 组织系统。

### 2. iWorkerCenter 经营与管理架构

面向产品、解决方案、售前与交付团队，解释 `iWorkerCenter` 为什么本质上是 CEO / 董事会的经营工具，以及它如何连接经营、组织与执行。

### 3. iWorkerCenter Executive Skills 体系
