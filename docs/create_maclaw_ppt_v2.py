...
defable_cell(slide, x, y, w, h,ext, sz=10, c=WHITE, b=False, fill=None, a=PP_ALIGN.CENTER):
rect(slide, x, y, w, h, fill=fill, line=RGBColor(0x1E,0x2A,0x50), st=MSO_SHAPE.RECTANGLE)
b(slide, x+Inches(0.06), y+Inches(0.04), w-Inches(0.12), h-Inches(0.08),ext, sz=sz, c=c, b=b, a=a)
...
tb(s, Inches(1), Inches(1.0), Inches(11), Inches(0.7), "MaClaw码卡龙", sz=58, c=WHITE, b=True, a=PP_ALIGN.CENTER)
...
rect(s, x, y,w,h, fill=DARK_CARD, line=ACCENT_BLUE)
b(s, x, y+Inches(0.06),w,h-Inches(0.12),ag, sz=12, c=ACCENT_CYAN, a=PP_ALIGN.CENTER)
...
tb(s, Inches(0), Inches(6.9), Inches(13.333), Inches(0.3), "(c) 2025 Dr. Daniel", sz=11, c=MID_GRAY, a=PP_ALIGN.CENTER)
print("P1 封面 完成")
...
for i, (num,itle, desc, color) in enumerate(toc):
y = Inches(1.9)+i*Inches(0.6)
rect(s, Inches(1.0), y, Inches(0.55), Inches(0.45), fill=color, st=MSO_SHAPE.RECTANGLE)
b(s, Inches(1.0), y+Inches(0.06), Inches(0.55), Inches(0.35), num, sz=13, c=WHITE, b=True, a=PP_ALIGN.CENTER)
b(s, Inches(1.8), y+Inches(0.02), Inches(3.0), Inches(0.25),itle, sz=14, c=WHITE, b=True)
b(s, Inches(1.8), y+Inches(0.26), Inches(8.0), Inches(0.2), desc, sz=10, c=MID_GRAY)
if i < len(toc)-1:
...
("基于 Wails + Go + Reac构建，集结构化工作流、长期记忆、知识库、技能扩展、多通道协作于一体。", 13, LIGHT_GRAY, False),
])
features = [
("", "能记", "内中外脑\n三层记忆", ACCENT_PURPLE),
("", "能学", "知识库+经验\n持续积累", ACCENT_BLUE),
...
for i, (icon,itle, desc, color) in enumerate(features):
x = Inches(0.8)+i*(fw+Inches(0.15)); y = Inches(4.2)
rect(s, x, y, fw, fh, fill=DARK_CARD, line=color)
b(s, x, y+Inches(0.15), fw, Inches(0.4), icon, sz=26, c=color, a=PP_ALIGN.CENTER)
b(s, x, y+Inches(0.55), fw, Inches(0.3),itle, sz=18, c=color, b=True, a=PP_ALIGN.CENTER)
line(s, x+Inches(0.3), y+Inches(0.9), fw-Inches(0.6), color, Pt(2))
b(s, x+Inches(0.2), y+Inches(1.05), fw-Inches(0.4), Inches(1.2), desc, sz=11, c=LIGHT_GRAY, a=PP_ALIGN.CENTER)
print("P3 产品定位 完成")
...
for i, (icon,itle, desc, color) in enumerate(pains):
col = i%3; row = i//3
x = Inches(0.8)+col*(pw+Inches(0.2)); y = Inches(2.2)+row*(ph+Inches(0.2))
rect(s, x, y, pw, ph, fill=DARK_CARD, line=color)
b(s, x+Inches(0.2), y+Inches(0.1), pw-Inches(0.4), Inches(0.35), icon+""+title, sz=16, c=color, b=True)
line(s, x+Inches(0.2), y+Inches(0.5), Inches(0.8), color, Pt(2))
b(s, x+Inches(0.2), y+Inches(0.65), pw-Inches(0.4), Inches(1.1), desc, sz=12, c=LIGHT_GRAY)
print("P4 痛点 完成")
...
b(s, x+Inches(0.2), y+Inches(0.15), cw-Inches(0.4), Inches(0.35),itle, sz=18, c=color, b=True)
line(s, x+Inches(0.2), y+Inches(0.55), Inches(1.2), color, Pt(2))
mp(s, x+Inches(0.2), y+Inches(0.75), cw-Inches(0.4), ch-Inches(1.0),
[f"*{it}" for iin items], sz=11, c=LIGHT_GRAY)
print("P5 设计哲学 完成")
...
("", "多通道协作", ACCENT_CYAN,
["桌面GUI · 终端TUI","微信/飞书/QQ/Telegram","REST API 多租户","AgentNeP2P网络"]),
]
...
("规划层", "结构化工作流 · 任务分解 · TDD验收需求→设计→编码→测试→集成→验收", ACCENT_PURPLE),
("执行层", "197+动态工具 · SSH远程 · 浏览器CDP · 桌面GUI工具按上下文按需激活", GREEN),
("进化层", "Combee经验聚合 · 能力缺口检测 · 技能自修复 · Nudge保守学习原则", ORANGE),
]
...
b(s, x+Inches(0.2), y+Inches(0.1), Inches(1.0), Inches(0.35),itle, sz=20, c=color, b=True)
b(s, x+Inches(1.3), y+Inches(0.15), Inches(4.0), Inches(0.25), subtitle, sz=12, c=YELLOW)
line(s, x+Inches(0.2), y+Inches(0.55), Inches(0.8), color, Pt(2))
b(s, x+Inches(0.2), y+Inches(0.7), dw-Inches(0.4), Inches(1.1), desc, sz=11, c=LIGHT_GRAY)
print("P8 差异化 完成")
