...
- 当前只可宣称“编译、板级初始化和启动资源预算已接入”。CO5300 实际屏幕构图、触控坐标方向与手势、PMIC 电量校准、麦克风/扬声器的 16 kHz contract、wake word、DISPLAY_OFF 后触摸/按键唤醒和 IMU 均须 COM6 HIL 后才可发布完整 capability evidence。
