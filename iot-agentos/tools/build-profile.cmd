...
:usage
echo Usage: %~nx0 ^<echoear-2st^|bread-compact^|bread-compact-renderer-fi^|fangtang-4g^|fangtang-4g-renderer-fi^|fangtang-4g-display-service-fi^|fangtang-4g-display-stop-timeout-fi^|fangtang-4g-fence-fi^|waveshare-amoled-1.75c^> [idf.py action...]
