...
device_status_t platform_connectivity_profile_prepare_cellular_transport(void) {
    return round_status_from_esp_err(legacy_connectivity_transport_prepare_cellular());
}

device_status_t platform_connectivity_profile_start_cellular_transport(uint32_t timeout_ms) {
    return round_status_from_esp_err(legacy_connectivity_transport_start_cellular(timeout_ms));
}
...
device_status_t platform_connectivity_profile_quiesce_cellular_transport(uint32_t timeout_ms) {
    return round_status_from_esp_err(legacy_connectivity_transport_quiesce_cellular(timeout_ms));
}
device_status_t platform_connectivity_profile_deinit_cellular_transport(uint32_t timeout_ms) {
    return round_status_from_esp_err(legacy_connectivity_transport_deinit_cellular(timeout_ms));
}
device_status_t platform_connectivity_profile_reinitialize_cellular_transport(uint32_t timeout_ms) {
    return round_status_from_esp_err(legacy_connectivity_transport_reinitialize_cellular(timeout_ms));
}
...
device_status_t platform_connectivity_profile_cellular_http_request(
    ...
    return round_status_from_esp_err(legacy_connectivity_transport_http_request(request));
}
...
device_status_t platform_connectivity_profile_cellular_http_stream_request(
    ...
    return round_status_from_esp_err(legacy_connectivity_transport_http_stream_request(request));
}
