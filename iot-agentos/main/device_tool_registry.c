...
static const device_tool_definition_t s_tools[] = {
    ...
    {"update_check", false, "{\"name\":\"update_check\",\"description\":\"Read the latest Hub-confirmed firmware update metadata. Updates require a connected computer and ClawMate Maker.\",\"risk\":\"read\",\"timeoutMs\":3000,\"inputSchema\":{\"type\":\"object\",\"properties\":{}}}", update_execute, update_ready},
