...
var businessViews = []BusinessViewDefinition{
	...
	{
		ID:           "company.project_directory",
		Domain:       "company",
		Title:        "Project directory",
		Description:  "Company project master for delivery, billing, and after-sales work.",
		DatasetID:    "company.projects",
		Fields:       []string{"project_no", "name", "customer_ref", "owner_ref", "department_ref", "status", "start_date", "end_date"},
		DefaultSort:  []SortSpec{{Field: "project_no", Direction: "asc"}},
		DefaultLimit: 100,
	},
	{
	...
	{
		ID:           "sales.service_ticket_queue",
		Domain:       "sales",
		Title:        "After-sales service ticket queue",
		Description:  "After-sales work orders linked to a customer, originating order, item, or installed asset.",
		DatasetID:    "sales.service_tickets",
		Fields:       []string{"ticket_no", "customer_ref", "order_ref", "item_ref", "asset_ref", "assignee_ref", "subject", "priority", "status", "opened_at"},
		DefaultSort:  []SortSpec{{Field: "opened_at", Direction: "desc"}},
		DefaultLimit: 100,
	},
	{
	...
	},
	{
		...
		Fields:       []string{"invoice_no", "counterparty", "invoice_type", "amount", "tax_amount", "currency", "status", "issue_date", "due_date"},
	...
	{
		ID:           "finance.bank_account_directory",
		Domain:       "finance",
		Title:        "Bank account directory",
		Description:  "Company bank account master for receipts, payments, and cash positioning.",
		DatasetID:    "finance.bank_accounts",
		Fields:       []string{"account_no", "account_name", "bank_name", "currency", "status"},
		DefaultSort:  []SortSpec{{Field: "account_no", Direction: "asc"}},
		DefaultLimit: 100,
	},
	{
	...
	},
	{
		...
		Description:  "On-hand quantity by item and warehouse. Item identity lives on inventory.items; quantity changes post through movements.",
		DatasetID:    "inventory.stock_balances",
		Fields:       []string{"item_no", "item_ref", "warehouse", "warehouse_ref", "quantity", "reserved_quantity", "unit", "status", "last_movement_at"},
	...
	},
	{
		...
		Fields:       []string{"asset_no", "name", "asset_type", "department", "custodian", "purchase_cost", "residual_value", "useful_life_months", "currency", "status", "purchase_date", "location"},
		DefaultSort:  []SortSpec{{Field: "asset_no", Direction: "asc"}},
		DefaultLimit: 100,
	},
	{
		ID:           "assets.maintenance_queue",
		Domain:       "assets",
		Title:        "Asset maintenance queue",
		Description:  "Repair and preventive-maintenance work orders against the single fixed-asset register.",
		DatasetID:    "assets.maintenance_orders",
		Fields:       []string{"wo_no", "asset_ref", "work_type", "assignee_ref", "priority", "status", "scheduled_at", "summary"},
		DefaultSort:  []SortSpec{{Field: "scheduled_at", Direction: "asc"}},
		DefaultLimit: 100,
	},
	{
		ID:           "manufacturing.bom_directory",
		Domain:       "manufacturing",
		Title:        "BOM directory",
		Description:  "Finished-item bills of materials on the shared item master.",
		DatasetID:    "manufacturing.boms",
		Fields:       []string{"bom_no", "item_ref", "item_no", "version", "status"},
		DefaultSort:  []SortSpec{{Field: "bom_no", Direction: "asc"}},
		DefaultLimit: 100,
	},
	{
		ID:           "manufacturing.production_order_tracker",
		Domain:       "manufacturing",
		Title:        "Production order tracker",
		Description:  "Production work orders for finished items on the shared item master.",
		DatasetID:    "manufacturing.production_orders",
		Fields:       []string{"mo_no", "item_ref", "bom_ref", "warehouse_ref", "sales_order_ref", "planned_qty", "completed_qty", "status", "due_date"},
		DefaultSort:  []SortSpec{{Field: "due_date", Direction: "asc"}},
		DefaultLimit: 100,
	},
}
