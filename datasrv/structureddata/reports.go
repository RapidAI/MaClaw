...
var reportDefinitions = []ReportDefinition{
	...
	{ID: "inventory.quantity_by_warehouse", Domain: "inventory", Title: "Inventory quantity by warehouse", Description: "On-hand quantity grouped by warehouse from stock balances.", DatasetID: "inventory.stock_balances", Aggregate: AggregateInput{GroupBy: []string{"warehouse"}, Metrics: []AggregateMetric{{Name: "balances", Op: "count"}, {Name: "quantity", Op: "sum", Field: "quantity"}}, Limit: 500}},
	{ID: "inventory.low_stock_summary", Domain: "inventory", Title: "Low stock summary", Description: "Low-stock balance count and quantity by warehouse.", DatasetID: "inventory.stock_balances", Aggregate: AggregateInput{Filter: map[string]any{"field": "status", "op": "eq", "value": "low_stock"}, GroupBy: []string{"warehouse"}, Metrics: []AggregateMetric{{Name: "balances", Op: "count"}, {Name: "quantity", Op: "sum", Field: "quantity"}}, Limit: 500}},
	...
	{ID: "assets.maintenance_by_status", Domain: "assets", Title: "Asset maintenance by status", Description: "Maintenance work-order count grouped by status.", DatasetID: "assets.maintenance_orders", Aggregate: AggregateInput{GroupBy: []string{"status"}, Metrics: []AggregateMetric{{Name: "work_orders", Op: "count"}}, Limit: 500}},
	{ID: "manufacturing.production_by_status", Domain: "manufacturing", Title: "Production orders by status", Description: "Production work-order count and planned quantity grouped by status.", DatasetID: "manufacturing.production_orders", Aggregate: AggregateInput{GroupBy: []string{"status"}, Metrics: []AggregateMetric{{Name: "production_orders", Op: "count"}, {Name: "planned_qty", Op: "sum", Field: "planned_qty"}}, Limit: 500}},
	{ID: "manufacturing.bom_by_status", Domain: "manufacturing", Title: "BOMs by status", Description: "Bill-of-materials count grouped by lifecycle status.", DatasetID: "manufacturing.boms", Aggregate: AggregateInput{GroupBy: []string{"status"}, Metrics: []AggregateMetric{{Name: "boms", Op: "count"}}, Limit: 500}},
}
