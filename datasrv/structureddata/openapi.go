...
func openAPISpec(version string) map[string]interface{} {
	...
	addQueryParameters(paths, map[string][]map[string]interface{}{
		...
		"/api/v1/data/app-installations": {
			...
			stringQueryParam("workspace_layout_fingerprint", "Filter installed MaClaw Apps by App Studio dynamic UI layout fingerprint preserved at install time."),
			stringQueryParam("layout_fingerprint", "Alias of workspace_layout_fingerprint."),
			stringQueryParam("hub_capability_id", "Filter installed MaClaw Apps by Hub capability id preserved in submission metadata."),
			stringQueryParam("capability_id", "Alias of hub_capability_id."),
			stringQueryParam("hub_market_capability_id", "Filter installed MaClaw Apps by market-facing Hub capability id."),
			stringQueryParam("market_capability_id", "Alias of hub_market_capability_id."),
			stringQueryParam("hub_submission_id", "Filter installed MaClaw Apps by Hub review submission id."),
			stringQueryParam("submission_id", "Alias of hub_submission_id."),
			stringQueryParam("hub_version_key", "Filter installed MaClaw Apps by Hub published version key."),
			stringQueryParam("version_key", "Alias of hub_version_key."),
			stringQueryParam("hub_review_status", "Filter installed MaClaw Apps by review or publish status captured at install time."),
			stringQueryParam("review_status", "Alias of hub_review_status."),
			...
			boolQueryParam("datasrv_registration_synced", "Filter installed MaClaw Apps by whether DataSrv app installation registration fully synced."),
			boolQueryParam("data_srv_registration_synced", "Alias of datasrv_registration_synced."),
			boolQueryParam("datasrv_registration_failed", "Filter installed MaClaw Apps by whether DataSrv app installation registration has failures."),
			boolQueryParam("data_srv_registration_failed", "Alias of datasrv_registration_failed."),
			boolQueryParam("datasrv_registration_partial", "Filter installed MaClaw Apps by whether DataSrv app installation registration partially succeeded."),
			boolQueryParam("data_srv_registration_partial", "Alias of datasrv_registration_partial."),
		},
		"/api/v1/data/relationships": {
...
func appInstallationMetadataOpenAPISchema() map[string]interface{} {
	...
	dependencySchema := map[string]interface{}{
		...
		"properties": map[string]interface{}{
			...
			"install_ref":      map[string]interface{}{"type": "string", "description": "Exact install reference used to resolve the dependency, such as a Hub capability id, SkillMarket install ref, GitHub raw URL, or repository URL."},
	...
	return map[string]interface{}{
		...
		"properties": map[string]interface{}{
			...
			"datasrv_registration": map[string]interface{}{
				"type":        "object",
				"description": "DataSrv app installation registration audit captured during Hub install or local install recovery.",
				"properties": map[string]interface{}{
					"synced":         map[string]interface{}{"type": "boolean"},
					"eligible_count": map[string]interface{}{"type": "integer"},
					"synced_count":   map[string]interface{}{"type": "integer"},
					"failed_count":   map[string]interface{}{"type": "integer"},
			...
			"install_evidence":                              map[string]interface{}{"type": "object", "description": "Nested per-app install evidence captured by RecordMaclawAppInstall, including version_snapshot, dependencies, workspace_layout, workflow_mapping, workflow_contract, result_contract, test_evidence, and dependency_verification."},
			"submission":                                    map[string]interface{}{"type": "object", "description": "Hub submission identity for the installed MaClaw App, including capability id, version key, review status, submission id, and package fingerprint."},
			"review_evidence":                               map[string]interface{}{"type": "object", "description": "Hub review evidence summary preserved from market review and package download."},
			"maclaw_app_review_evidence":                    map[string]interface{}{"type": "object", "description": "MaClaw App review evidence alias used by Hub and GUI review surfaces."},
			"review_evidence_status":                        map[string]interface{}{"type": "string", "description": "Hub review or publish status summarized from review_evidence."},
			"review_evidence_run_id":                        map[string]interface{}{"type": "string", "description": "Run id from Hub review evidence."},
			"review_evidence_test_protocol_fingerprint":     map[string]interface{}{"type": "string", "description": "App Studio test protocol fingerprint from Hub review evidence."},
			"review_evidence_result_contract_primary":       map[string]interface{}{"type": "string", "description": "Primary result contract channel observed by Hub review."},
			"review_evidence_result_coverage_primary":       map[string]interface{}{"type": "string", "description": "Primary result coverage channel observed by Hub review."},
			"review_evidence_result_coverage_covered_count": map[string]interface{}{"type": "integer", "description": "Number of result contract types covered during Hub review."},
			"review_evidence_result_coverage_missing_count": map[string]interface{}{"type": "integer", "description": "Number of result contract types missing during Hub review."},
			"review_evidence_output_count":                  map[string]interface{}{"type": "integer", "description": "Number of display outputs summarized by Hub review evidence."},
			"review_evidence_artifact_count":                map[string]interface{}{"type": "integer", "description": "Number of file artifacts summarized by Hub review evidence."},
			"review_evidence_approval_status":               map[string]interface{}{"type": "string", "description": "Approval status summarized by Hub review evidence for enterprise approval apps."},
			"review_evidence_current_node":                  map[string]interface{}{"type": "string", "description": "Approval workflow node summarized by Hub review evidence."},
			"hub_capability_id":                             map[string]interface{}{"type": "string", "description": "Hub capability id that distributed the installed App."},
			"hub_market_capability_id":                      map[string]interface{}{"type": "string", "description": "Market-facing Hub capability id used during installation."},
			"hub_submission_id":                             map[string]interface{}{"type": "string", "description": "Hub review submission id for the installed package."},
			"hub_version_key":                               map[string]interface{}{"type": "string", "description": "Hub version key used to identify the published package version."},
			"hub_review_status":                             map[string]interface{}{"type": "string", "description": "Review or publish status observed when the App was installed."},
			"hub_package_sha256":                            map[string]interface{}{"type": "string", "description": "SHA-256 fingerprint of the Hub package version."},
			"hub_package_signature":                         map[string]interface{}{"type": "object", "description": "Signed Hub package signature evidence preserved from the installed MaClaw App package and mirrored from submission.package_signature."},
			"hub_package_signature_algorithm":               map[string]interface{}{"type": "string", "description": "Signature algorithm used for the Hub package signature, such as ed25519."},
			"hub_package_signature_fingerprint":             map[string]interface{}{"type": "string", "description": "Public key fingerprint used to verify the Hub package signature."},
			"hub_package_signature_signed_at":               map[string]interface{}{"type": "string", "description": "Timestamp when the Hub package was signed."},
			"hub_package_signature_signed_by":               map[string]interface{}{"type": "string", "description": "Hub actor or service that signed the package."},
			...
			"workspace_layout_fingerprint":                map[string]interface{}{"type": "string", "description": "Stable App Studio layout fingerprint used to verify the installed UI layout matches the reviewed Hub package."},
			...
			"workspace_layout_visible_region_count":       map[string]interface{}{"type": "integer", "description": "Number of visible layout regions after App Studio visual edits such as hiding detail panels."},
			...
			"workspace_layout_studio_saved_in_manifest":   map[string]interface{}{"type": "boolean", "description": "True when the visual layout was saved back into the MaClaw App manifest by App Studio."},
			"workspace_layout_studio_editable":            map[string]interface{}{"type": "boolean", "description": "True when the layout remains editable in App Studio."},
			"workspace_layout_studio_updated_by":          map[string]interface{}{"type": "string", "description": "Tool or actor that last updated the App Studio layout evidence."},
			...
			"test_evidence_approval_current_node":         map[string]interface{}{"type": "string", "description": "Current approval workflow node observed in the tested approval instance."},
			"test_evidence_workflow_skill_id":             map[string]interface{}{"type": "string", "description": "Workflow Skill id that handled the tested approval instance."},
			"test_evidence_workflow_version":              map[string]interface{}{"type": "string", "description": "Workflow Skill version used by the tested approval instance."},
			"test_evidence_business_status":               map[string]interface{}{"type": "string", "description": "Business status returned by the approval workflow result package."},
			"test_evidence_result_status":                 map[string]interface{}{"type": "string", "description": "Result status returned by the approval workflow result package."},
			"test_evidence_dataset_id":                    map[string]interface{}{"type": "string", "description": "DataSrv dataset id associated with the tested approval instance."},
			"test_evidence_blueprint_id":                  map[string]interface{}{"type": "string", "description": "DataSrv blueprint id associated with the tested approval instance."},
			"test_evidence_object_role":                   map[string]interface{}{"type": "string", "description": "Business object role associated with the tested approval instance."},
			"test_evidence_approval_event":                map[string]interface{}{"type": "string", "description": "Approval event that started the tested workflow."},
			"test_evidence_approval_workflow_id":          map[string]interface{}{"type": "string", "description": "Approval workflow id associated with the tested approval instance."},
			"test_evidence_detail_url":                    map[string]interface{}{"type": "string", "description": "External or DataSrv detail URL for the tested approval instance."},
...
func recordApprovalWorkflowOpenAPIProperties() map[string]interface{} {
	return map[string]interface{}{
		...
		"current_node_status":   map[string]interface{}{"type": "string", "description": "Current workflow node status such as waiting, running, requires_input, completed, or attention."},
		"node_tasks":            map[string]interface{}{"type": "array", "items": map[string]interface{}{"type": "object", "additionalProperties": true}, "description": "Current workflow node task summaries for app approval workspaces."},
...
func recordApprovalRequestOpenAPISchema() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"properties": map[string]interface{}{
			...
			"workflow_node_id":      stringProp("Workflow node id used by the approval workflow."),
			"workflowNodeId":        stringProp("JavaScript-style alias of workflow_node_id."),
			...
			"workflowNodeIds":       map[string]interface{}{"type": "array", "items": map[string]interface{}{"type": "string"}, "description": "JavaScript-style alias of workflow_node_ids."},
			"current_node_status":   stringProp("Current workflow node status."),
			"currentNodeStatus":     stringProp("CamelCase alias of current_node_status."),
			"node_status":           stringProp("Current workflow node status alias."),
			"nodeStatus":            stringProp("CamelCase alias of node_status."),
			"node_tasks":            map[string]interface{}{"type": "array", "items": map[string]interface{}{"type": "object", "additionalProperties": true}, "description": "Current workflow node task summaries."},
			"nodeTasks":             map[string]interface{}{"type": "array", "items": map[string]interface{}{"type": "object", "additionalProperties": true}, "description": "CamelCase alias of node_tasks."},
			"approval_tasks":        map[string]interface{}{"type": "array", "items": map[string]interface{}{"type": "object", "additionalProperties": true}, "description": "Approval task summaries alias."},
			"approvalTasks":         map[string]interface{}{"type": "array", "items": map[string]interface{}{"type": "object", "additionalProperties": true}, "description": "CamelCase alias of approval_tasks."},
			...
			"workflow_decision_id":  stringProp("Workflow decision event id."),
			"workflowDecisionId":    stringProp("JavaScript-style alias of workflow_decision_id."),
			...
			"from_status":           stringProp("Business status before this approval transition."),
			"fromStatus":            stringProp("CamelCase alias of from_status."),
			"to_status":             stringProp("Business status after this approval transition."),
			"toStatus":              stringProp("CamelCase alias of to_status."),
			"business_status":       stringProp("Business-facing approval state."),
			"businessStatus":        stringProp("CamelCase alias of business_status."),
			"result_status":         stringProp("Machine-readable approval result state."),
			"resultStatus":          stringProp("CamelCase alias of result_status."),
			"result_payload":        map[string]interface{}{"type": "object", "description": "Structured approval result payload embedded in request context."},
			"resultPayload":         map[string]interface{}{"type": "object", "description": "CamelCase alias of result_payload."},
			"outputs":               map[string]interface{}{"type": "array", "items": recordApprovalOutputOpenAPISchema(), "description": "Displayable approval outputs embedded in request context."},
			"artifacts":             map[string]interface{}{"type": "array", "items": recordApprovalArtifactOpenAPISchema(), "description": "Approval artifacts embedded in request context."},
