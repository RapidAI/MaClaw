...
var businessActions = []BusinessAction{
	...
	{
		ID:             "company.project_upsert",
		Domain:         "company",
		Title:          "Create or update project",
		Description:    "Use when company project master data, customer, owner, department, or schedule changes.",
		DatasetID:      "company.projects",
		EventType:      "company.project.updated",
		Operation:      "upsert_record",
		RequiredFields: []string{"project_no", "name"},
		SuggestedTags:  []string{"company", "project"},
		InputFields:    templateFields("company.projects"),
	},
	{
	...
	{
		ID:             "sales.service_ticket_upsert",
		Domain:         "sales",
		Title:          "Create or update after-sales service ticket",
		Description:    "Use when after-sales work is opened, assigned, or closed against a customer, order, item, or installed asset.",
		DatasetID:      "sales.service_tickets",
		EventType:      "sales.service_ticket.updated",
		Operation:      "upsert_record",
		RequiredFields: []string{"ticket_no", "customer_ref", "subject"},
		SuggestedTags:  []string{"sales", "service", "after_sales"},
		InputFields:    templateFields("sales.service_tickets"),
	},
	{
	...
	{
		ID:             "finance.bank_account_upsert",
		Domain:         "finance",
		Title:          "Create or update bank account",
		Description:    "Use when company bank account master data, bank name, currency, or status changes.",
		DatasetID:      "finance.bank_accounts",
		EventType:      "finance.bank_account.updated",
		Operation:      "upsert_record",
		RequiredFields: []string{"account_no", "account_name", "bank_name"},
		SuggestedTags:  []string{"finance", "bank", "cash"},
		InputFields:    templateFields("finance.bank_accounts"),
	},
	{
	...
	},
	{
		...
		Description:    "Use when item identity or specification changes. Do not use this to post on-hand quantity; use inventory.stock_update or inventory.movement_record.",
	...
	},
	{
		...
		Description:    "Use for stock-count or reservation updates on the warehouse balance row. Quantity changes that need a ledger should use inventory.movement_record.",
		DatasetID:      "inventory.stock_balances",
		EventType:      "inventory.stock.updated",
		Operation:      "merge_record",
		RequiredFields: []string{"quantity"},
		SuggestedTags:  []string{"inventory", "stock"},
		InputFields: []DatasetTemplateField{
			{Key: "item_ref", Type: "record_ref", Title: "Item Ref", Config: refFieldConfig("inventory.items")},
			{Key: "warehouse_ref", Type: "record_ref", Title: "Warehouse Ref", Config: refFieldConfig("inventory.warehouses")},
			{Key: "quantity", Type: "number", Title: "Quantity", Required: true},
			{Key: "reserved_quantity", Type: "number", Title: "Reserved Quantity"},
			{Key: "warehouse", Type: "string", Title: "Warehouse"},
			{Key: "status", Type: "string", Title: "Status", Config: enumFieldConfig("active", "low_stock", "reserved", "inactive")},
	...
	{
		ID:             "assets.maintenance_order_upsert",
		Domain:         "assets",
		Title:          "Create or update asset maintenance order",
		Description:    "Use when repair or preventive-maintenance work is opened against the single fixed-asset register.",
		DatasetID:      "assets.maintenance_orders",
		EventType:      "assets.maintenance_order.updated",
		Operation:      "upsert_record",
		RequiredFields: []string{"wo_no", "asset_ref"},
		SuggestedTags:  []string{"assets", "maintenance"},
		InputFields:    templateFields("assets.maintenance_orders"),
	},
	{
		ID:             "manufacturing.bom_upsert",
		Domain:         "manufacturing",
		Title:          "Create or update bill of materials",
		Description:    "Use when a finished-item BOM header is created or versioned. Component rows live in manufacturing.bom_components.",
		DatasetID:      "manufacturing.boms",
		EventType:      "manufacturing.bom.updated",
		Operation:      "upsert_record",
		RequiredFields: []string{"bom_no", "item_ref"},
		SuggestedTags:  []string{"manufacturing", "bom"},
		InputFields:    templateFields("manufacturing.boms"),
	},
	{
		ID:             "manufacturing.production_order_upsert",
		Domain:         "manufacturing",
		Title:          "Create or update production order",
		Description:    "Use when a production work order is created or progressed for a finished item on the shared item master.",
		DatasetID:      "manufacturing.production_orders",
		EventType:      "manufacturing.production_order.updated",
		Operation:      "upsert_record",
		RequiredFields: []string{"mo_no", "item_ref", "planned_qty"},
		SuggestedTags:  []string{"manufacturing", "production"},
		InputFields:    templateFields("manufacturing.production_orders"),
	},
}
