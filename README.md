...
**MaClaw（码卡龙）** 是你的**爱马仕智能体系统** —— 无论是专业软件开发者还是普通白领，它都是你身边最贴心的 AI 搭档。它不仅懂代码，更懂你：可定制人格、长期记忆你的偏好，在你工作时给予精神陪伴，在你忙碌时自动接管任务。基于 Wails + Go + React 构建，集**三态编程、智能体编排、人格系统、长期记忆、SSH/浏览器监管**于一体，**软件开发、白领办公、日常事务**统统拿下。
